...
public class Game_Control : MonoBehaviour
{
    ...
    static public float Base_Player_Pickup_Range = 5;
    ...
    static public int Max_Enemies = 1000; //Makes sure that too many enemies are not spawned at the same time which would cause preformance issues.
...
// Start is called before the first frame update
    ...
    void UpdatePlayerStats()
    {
        ...
        Player_Pickup_Range = Base_Player_Pickup_Range + (Pickup_Range_Level * 5);
    }
